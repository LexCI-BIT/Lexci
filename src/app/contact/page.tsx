                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start gap-4 group">
                        ...
                        <div>
                          <p className="text-[10px] font-medium tracking-widest text-white/30 uppercase mb-1">Inquiries</p>
                          <a href="mailto:hello@lexci.ai" className="text-white/70 hover:text-white transition-colors font-light">hello@lexci.ai</a>
                        </div>
                      </div>
                      <div className="flex items-start gap-4 group">
                        <div className="w-10 h-10 rounded-xl bg-white/[0.03] border border-white/10 flex items-center justify-center shrink-0 group-hover:bg-purple-500/10 group-hover:border-purple-500/30 transition-all">
                          <Globe className="w-4 h-4 text-white/40 group-hover:text-purple-400 transition-colors" />
                        </div>
                        <div>
                          <p className="text-[10px] font-medium tracking-widest text-white/30 uppercase mb-1">Partnerships</p>
                          <a href="mailto:partners@lexci.ai" className="text-white/70 hover:text-white transition-colors font-light">partners@lexci.ai</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <FadeIn delay={0.4}>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-4 group">
                      ...
                      <div>
                        <p className="text-[10px] font-medium tracking-widest text-white/30 uppercase mb-1">Headquarters</p>
                        <p className="text-white/70 font-light leading-relaxed">
                          124 Brompton Road<br />
                          Knightsbridge, London SW3 1JD<br />
                          United Kingdom
                        </p>
                      </div>
                    </div>
